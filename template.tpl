...
- name: city
  code: |-
    mock('getRemoteAddress', function() {
      return '1.2.3.4';
    });
    ...
    mock('sendHttpGet', function(url, options) {
      return {
        then: function(onSuccess, onFailure) {
          return onSuccess({
            statusCode: 200,
            body: '{"ip":"1.2.3.4","city":"Istanbul","region":"Istanbul","country":"TR","postal":"34000","timezone":"Europe/Istanbul","loc":"41.0082,28.9784"}'
          });
        }
      };
    });
...
- name: country
  code: |-
    ...
    assertThat(result).isEqualTo('TR');
- name: postal
  code: |-
    mock('getRemoteAddress', function() {
      return '1.2.3.4';
    ...
    assertThat(result).isEqualTo('34000');
- name: timezone
  code: |-
    mock('getRemoteAddress', function() {
      return '1.2.3.4';
    ...
    const result = runCode({
      token: 'test-token',
      outputField: 'timezone'
    });

    assertThat(result).isEqualTo('Europe/Istanbul');
- name: loc
  code: |-
    mock('getRemoteAddress', function() {
      return '1.2.3.4';
    ...
    assertThat(result).isEqualTo('41.0082,28.9784');
setup: ''
